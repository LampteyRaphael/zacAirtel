            ...
            <table class="table table-condensed table-hover table-responsive-lg">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('warehousecategory.edit',$value->id) }}" class="btn btn-primary"><i class="fa fa-edit"></i></a>

                            <a href="{{ route('warehousecategory.destroy',$value->id) }}" onclick="return confirm('Are you sure you want to delete the request pending?')" class="btn btn-danger"><i class="fa fa-recycle"></i></a>
                        </td>
                    </tr>
                @endforeach
                </tbody>
