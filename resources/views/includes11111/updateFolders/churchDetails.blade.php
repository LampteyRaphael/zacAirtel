...
{{--            <button id="btn7" class="btn btn-primary pull-right" onclick="return step4NextFunction()">Continue</button>--}}
{{--            <button id="btn8" class="btn btn-danger pull-right" onclick="return step4BackFunction()">Back</button>--}}
        </div>
    </div>
</div>