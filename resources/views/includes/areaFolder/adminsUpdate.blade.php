                ...
                @else
                    <div class="col-md-6">
                        <div class="form-group ">
                            ...
                            <div class="input-group">
                                <div class="input-group-addon"><i class="fa fa-wrench"></i></div>
                                {!! Form::select('role_id',[$user->role_id=>$user->role->name]+$roles,$user->role_id,['class'=>'form-control','required'=>'required']) !!}
                            </div>
                        </div>
                    </div>
...
{{--                    </div>--}}
                    ...
                    <div class="">
                        <div class="form-group pull-right">
                            {!! Form::model($user,['method'=>'DELETE','action'=>['Area\AreaUsersUpdatingController@destroy',$user->id],'onsubmit' => 'return ConfirmDelete()',],['class'=>'form-inline'])!!}
