<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="/" class="brand-link">
      ...
      <span class="brand-text font-weight-light"><b>GH Electricals Delears</b></span>
    </a>
...
@if(auth()->user()->role_id===1)
          ...
          {{-- <li class="nav-item"><a class="nav-link " href="#"><i class="nav-icon fas fa-circle"></i> <p>Reject  </p></a></li>
          <li class="nav-item has-treeview"><a class="nav-link " href="#"><i class="nav-icon fas fa-circle"></i> <p>Level1 <i class="right fas fa-angle-left"></i> </p></a> --}}
          {{-- <ul class="nav nav-treeview">
          <li class="nav-item"><a class="nav-link " href="#"><i class="nav-icon far fa-circle"></i> <p>Level2  </p></a></li>
          <li class="nav-item has-treeview"><a class="nav-link " href="#"><i class="nav-icon far fa-circle"></i> <p>Level2 <i class="right fas fa-angle-left"></i> </p></a>
          <ul class="nav nav-treeview">
          <li class="nav-item"><a class="nav-link " href="#"><i class="nav-icon far fa-dot-circle"></i> <p>Level3  </p></a></li>
          <li class="nav-item"><a class="nav-link " href="#"><i class="nav-icon far fa-dot-circle"></i> <p>Level3  </p></a></li>
          <li class="nav-item"><a class="nav-link " href="#"><i class="nav-icon far fa-dot-circle"></i> <p>Level3  </p></a></li>
          </ul>
          </li>
          ...
          <li class="nav-item">
            <a href="{{ route('warehouse.index') }}" class="nav-link  {{ $elementActive ?? '' == 'contact' ? 'active' : '' }}">
            <i class="nav-icon fas fa-id-card-alt"></i>
              <p>
                Sales Point
